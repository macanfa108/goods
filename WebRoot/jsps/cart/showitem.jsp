...
<html>
  <head>
	...
	<script src="<%=path %>/jsps/js/round.js"></script>
	
	<link rel="stylesheet" type="text/css" href="<%=path%>/jsps/css/cart/showitem.css">
...
<c:forEach items="${cartItemList }" var="cartItem">
	...
	<tr>
		<td colspan="5" bgcolor="#FD9231"><span style="font-weight: 900">收货地址</span></td>
	</tr>
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="广东省 湛江市 麻章区 广东海洋大学 王老五"/>
		</td>
	</tr>
	<tr>
